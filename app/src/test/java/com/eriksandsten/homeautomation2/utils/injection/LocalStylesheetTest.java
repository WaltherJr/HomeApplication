...
public class LocalStylesheetTest {

    @Test
    public void getInjectionCodeTest() throws IOException, InterruptedException {
        String s = TestUtils.normalizeJS(new LocalStylesheet("hello-world-stylesheet", "html, body {margin: 0; padding: 0;}").getInjectionCode());
