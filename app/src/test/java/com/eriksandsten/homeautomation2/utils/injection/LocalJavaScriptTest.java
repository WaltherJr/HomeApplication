...
public class LocalJavaScriptTest {

    @Test
    public void getInjectionCodeTest() throws IOException {
        String s = TestUtils.normalizeJS(new LocalJavaScript("hello-world-script", DOMTarget.BODY, "alert('Hello world!');").getInjectionCode());
