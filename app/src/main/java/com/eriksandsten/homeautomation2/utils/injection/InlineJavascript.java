...
@Data
public class InlineJavascript extends Javascript {
    private String scriptContent;

    public InlineJavascript() {
        super();
    }

    public InlineJavascript(String scriptName, DOMTarget domTarget, String scriptContent) {
